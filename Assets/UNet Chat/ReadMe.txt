...
- Get Started: -------------------------------------------------------------------------------
 ...
 - Import UNet Chat Package into your project.
    ...
    - For test:
           ...
           - Writte your player name and click on next button.
...
Integrate chat is simple, just requiered that you send the player name to register a client on the chat,
...
- Remenber if you use this, set the variable "Show Player Name Input" to false for avoid show the inputfield in the chat.

----------------------------------------------------

For assign / change the group in runtime you can do this:

 - Get a refence (if not have one) of bl_ChatManager like above, eg: public bl_ChatManager myChat; //assign in inspector
 - Then, just call like this: MyChat.ChangeGroup(groupid);
